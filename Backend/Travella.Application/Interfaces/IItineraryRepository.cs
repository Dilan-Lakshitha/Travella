...
namespace Travella.Application.Interfaces
{
    public interface IItineraryRepository
    {
        ...
        Task<List<ItineraryListItemDto>> GetCompanyItinerariesAllAsync(int companyId);

        Task<Dictionary<string, int>> GetCompanyItineraryStatusCountsAsync(int companyId);
        ...
        Task<List<ItineraryMessageDto>> GetItineraryMessagesAsync(int itineraryId, bool includeInternalNotes);

        Task<int> AddItineraryMessageAsync(int itineraryId, int senderId, string senderRole, string message, string type);

        Task SetAssignedReviewerAsync(int itineraryId, int reviewerUserId);

        Task<bool> TryAssignReviewerIfUnsetAsync(int itineraryId, int reviewerUserId);

        Task<int?> GetAssignedReviewerIdAsync(int itineraryId);
