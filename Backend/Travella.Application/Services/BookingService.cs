    ...
    public class BookingService : IBookingService
    {
        ...
        public async Task<int> CreateBookingAsync(BookingDto dto)
        {
            ...
            try
            {
                ...
                var confirmedItinerary = await _itineraryRepository.GetItineraryByIdAsync(dto.ItineraryId);
                if (confirmedItinerary != null && confirmedItinerary.CompanyId.HasValue)
                {
                    await _staffEmailNotifier.NotifyItineraryConfirmedAsync(confirmedItinerary, confirmedItinerary.CompanyId.Value);
                }
