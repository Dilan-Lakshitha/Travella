...
namespace Travella.Application.Services
{
    public interface IAdminService
    {
        ...
        Task<int> CreateDriverAsync(string name, string phone, int experience, string availability, int companyId);
        Task<int> CreateGuideAsync(string name, string phone, int experience, string availability, int companyId);
    ...
    public class AdminService : IAdminService
    {
        ...
        public AdminService(IAuthRepository authRepository, IStaffService staffService, IUnitOfWork unitOfWork)
        {
        ...
        public async Task<int> CreateDriverAsync(string name, string phone, int experience, string availability, int companyId)
        {
            var staff = new Staff
            {
                Name = name.Trim(),
        ...
        public async Task<int> CreateGuideAsync(string name, string phone, int experience, string availability, int companyId)
        {
            var staff = new Staff
            {
                Name = name.Trim(),
